...
#define SAVE_STACK							\
  {									\
    ...
    printf_small("\n\rStored %d elements for task %d", gl_current_task->pxstack - gl_current_task->pxstack_start, gl_next_task_id);	\
  }
...
#define RESTORE_STACK							\
  {									\
    ...
    printf_small("\n\rRestored %d elements for task %d", SP - gl_start_of_stack, gl_next_task_id); \
  }
...
void suspend_task(void) _naked					
  {							
    ...
    getchar();
    TL0=0xC3; TH0=0xB7;  // reload value
